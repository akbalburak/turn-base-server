    ...
    public static class CampaignController
    {
            ...
            BattleDifficulityData levelData)
        {
            ...
            lock (user)
            {
                ...
                CampaignDTO campaign = GetCampaign(userData);
                ...
                UpdateCampaign(userData, campaign);
                ...
                if (firstTimeVictory)
                {
                    ...
                    InventoryDTO inventory = InventoryController.GetInventory(userData);
                    ...
                    InventoryController.UpdateInventory(userData, inventory);
